...
def upgrade() -> None:
    ...
    sa.Column('kind', sa.Enum('BOOK', 'ARTICLE', name='itemkind', native_enum=False), nullable=False),
    sa.Column('status', sa.Enum('PLANNED', 'READING', 'DONE', name='itemstatus', native_enum=False), nullable=False),
