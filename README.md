...
- Pre-commit hooks для автоматического линтинга и тестов перед коммитом
...
Проект использует pre-commit hooks для автоматического запуска линтинга и тестов перед каждым коммитом.

```bash
# Установить hooks (один раз)
pre-commit install
