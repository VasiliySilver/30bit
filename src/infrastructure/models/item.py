...
class ItemModel(Base):
    ...
    kind: Mapped[ItemKind] = mapped_column(SQLEnum(ItemKind, native_enum=False), nullable=False, index=True)
    status: Mapped[ItemStatus] = mapped_column(SQLEnum(ItemStatus, native_enum=False), nullable=False, index=True)
    priority: Mapped[Priority] = mapped_column(SQLEnum(Priority, native_enum=False), nullable=False, index=True)
