...
class TagService:
    ...
    async def create_tag(self, user_id: int, data: TagCreate) -> TagResponse:
        ...
        entity = Tag(id=None, user_id=user_id, name=data.name)
    ...
    async def get_tag(self, tag_id: int, user_id: int) -> TagResponse:
        ...
        return TagResponse(id=entity.id, user_id=entity.user_id, name=entity.name)
    ...
    async def get_user_tags(
        ...
        return [
            TagResponse(id=entity.id, user_id=entity.user_id, name=entity.name)
